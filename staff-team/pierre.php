...
<html lang="en">
    ...
    <header id="header" class="header">
        ...
        <div class="body-content">
            <img src="../__assets/img/pierre.png" alt="Pierre.gif">
            <br><br>
            <h1>Pierre</h1>
            <br>
            <p>
            Pierre is the only female staff member we have at PM, but she is amazing at her job. She loves playing Valorant and was the inspiration for this website.
            </p>
            <br>
