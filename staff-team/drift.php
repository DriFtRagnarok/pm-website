...
<html lang="en">
    ...
    <header id="header" class="header">
        ...
        <div class="body-content">
            ...
            <br><br>
            <h1>DriFt Ragnarok/Personalized Modifications</h1>
            <br>
            <p>
                DriFt Ragnarok, or PM for short, is a 3d modeler, designer, and is the founder of Personalized Modifications in December of 2019. He is currently enrolled at a local community college and studying Computer Science. He is also a martial artist working his way up to Black Belt! At the time of writing this, he is currently a blue belt in Taekwondo, or 4 belts from black belt.
            </p>
            <br>
            <h3>DM status: <span class="open">Open</span></h3>
        </div>
        <footer class="footer">
